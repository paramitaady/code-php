...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="../admin/data_penduduk.php">Tabel</a></li>
      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-header">
            <div class="box-body">
              <center>
                <h3><b>IMPORT FILE EXCEL</b></h43>
              </center><br>
              <h4>Silahkan Upload File Excel anda disini :)</h4>
            </div>
           <!--  <a href="../admin/tables/data_penduduk.php">Kembali</a> -->
           <!--  <br>
            <br> -->

            <form method="POST" enctype="multipart/form-data" action="proses_upload.php">
              <h4>Pilih File:</h4>
              <input name="filependuduk" type="file" required="required"><br>
