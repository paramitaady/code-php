...
<div class="content-wrapper">
  ...
  <section class="content">
   ...
   <div class="box box-default">
    ...
    <!-- /.box-header -->
    <div class="box-body">
     <h3><center>Halaman Surat Pengantar KTP</center></h3><hr><br>
     <!--    <form action="../surat/pengantar.php" method="POST"> -->
      <form action="../../proses/tambah_pengantar.php" method="POST">
       ...
       <div class="row">
        <div class="col-md-6">
          ...
          <div class="form-group">
            <label>Nama</label>
            <div style="width: 100%;">
              <input id="nama" type="text" name="nama" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div style="width: 100%;">
              <input id="tempat_lahir" type="text" name="tempat_lahir" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div style="width: 100%;">
              <input id="tanggal_lahir" type="date" name="tanggal_lahir" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div style="width: 100%;">
              <input id="jenis_kelamin" type="text" name="jenis_kelamin" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <div class="form-group">
            <label>Agama</label>
            <div style="width: 100%;">
              <input id="agama" type="text" name="agama" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <div class="form-group">
            <label>Alamat</label>
            <div style="width: 100%;">
              <input id="alamat" type="text" name="alamat" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
        </div>
        ...
        <div class="form-group" hidden>
          ...
          <div style="width: 100%;">
            <input id="keterangan" type="text" name="keterangan" class="form-control col-md-7 col-xs-12"  required="required" value="Pengantar KTP">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div style="width: 100%;">
            <input id="tujuan" type="text" name="tujuan" class="form-control col-md-7 col-xs-12"  required="required" value="Disdukpil">
          </div>
        </div>
        <br><br>
        ...
        <div class="form-group">
          ...
          <div style="width: 100%;">
            <input id="perihal" type="text" name="perihal" class="form-control col-md-7 col-xs-12"  required  value="untuk mengurus Kartu Tanda Penduduk (KTP)">
          </div>
        </div><br><br><br>
        <!-- KOLOM KEDUA END -->
