...
<div class="content-wrapper">
  ...
  <section class="content">
   ...
   <div class="box box-default">
    ...
    <!-- /.box-header -->
    <div class="box-body">
     <h3><center>Halaman Surat Rekomendasi</center></h3><hr><br>
  <!--    <form action="../surat/pengantar.php" method="POST"> -->
      <form action="../../proses/tambah_rekomendasi.php" method="POST">
 ...
 -->
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <div style="width: 100%;">
            <input id="keterangan" type="text" name="keterangan" class="form-control col-md-7 col-xs-12"  required="required" value="Untuk mengurus pencairan dana">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div style="width: 100%;">
            <input id="organisasi" type="text" name="organisasi" class="form-control col-md-7 col-xs-12"  required="required">
          </div>
        </div><br><br><br>
        <!-- KOLOM KEDUA END -->
