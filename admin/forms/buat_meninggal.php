...
<div class="content-wrapper">
  ...
  <section class="content">
   ...
   <div class="box box-default">
    ...
    <!-- /.box-header -->
    <div class="box-body">
     <h3><center>Halaman Surat Keterangan Kematian</center></h3><hr><br>
  <!--    <form action="../surat/pengantar.php" method="POST"> -->
      <form action="../../proses/tambah_meninggal.php" method="POST">
 ...
 -->
        ...
        <div class="form-group">
          ...
          <div style="width: 100%;">
            <input id="keterangan" type="text" name="keterangan" class="form-control col-md-7 col-xs-12"  required="required" value="Keterangan Kematian">
          </div>
        </div><br>
        ...
        <div class="form-group">
          ...
          <div style="width: 100%;">
            <input id="tgl_meninggal" type="date" name="tgl_meninggal" class="form-control col-md-7 col-xs-12"  required="required">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div style="width: 100%;">
            <input id="perihal" type="hidden" name="perihal" class="form-control col-md-7 col-xs-12"  required="required" value="Untuk membuat surat keteranga meninggal dunia">
          </div>
        </div><br><br><br>
        <!-- KOLOM KEDUA END -->
