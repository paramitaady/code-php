...
<div class="content-wrapper">
  ...
  <section class="content-header">
   ...
   <ol class="breadcrumb">
    ...
    <li><a href="tambah_kegiatan.php">Form</a></li>
    <li class="active">Kegiatan Desa</li>
  </ol>
</section>
...
<section class="content">
 ...
 <div class="box box-default">
  <div class="box-header with-border">
    <h3><center>Form Tambah Data Kegiatan Desa</center></h3><hr><br>
    <div class="x_content">
      <form action="../../proses/proses_tambah_kegiatan.php" class="form-horizontal form-label-left" novalidate  method="POST" >

         <!--  <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="id_kegiatan">Id Kegiatan
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="id_kegiatan" class="form-control col-md-7 col-xs-12" name="id_kegiatan" type="text" required="required">
            </div>
          </div> -->
          ...
          <div class="form-group row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="nama_kegiatan" type="text" name="nama_kegiatan" class="form-control col-md-7 col-xs-12" required="required">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <select name="lembaga"  class="form-control select2" style="width: 100%;" required>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="tanggal_kegiatan" type="date" name="tanggal_kegiatan" class="form-control col-md-7 col-xs-12" required>
            </div>
          </div>
          ...
          <!-- <div class="form-group row">
            <label for="dana" class="control-label col-md-3 col-sm-3 col-xs-12">Dana
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="dana" type="text" name="lokasi" class="form-control col-md-7 col-xs-12" required="required">
            </div>
          </div> -->

          <center>
            <a href="../forms/tambah_kegiatan.php" class="btn btn-warning" type="submit" name="submit" value="submit">Batal</a>
            <input class="btn btn-primary" type="submit" id="btn-submit" name="submit" value="Submit" onclick="return tambahKegiatan();">
          </center>
