...
<section class="content">
  ...
  <div class="box box-default">
    <div class="box-header with-border">
      ...
      <div class="x_content">
        <form action="../../proses/proses_tambah_laporan.php" class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">

          <!-- <div class="form-group row">
            <label for="id_laporan" class="control-label col-md-3 col-sm-3 col-xs-12" >ID Laporan
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input class="form-control col-md-7 col-xs-12" name="id_laporan" type="text" required="required">
            </div>
          </div> -->
          ...
          <div class="form-group row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="date" name="tanggal" class="form-control col-md-7 col-xs-12" required="required">
            </div>
          </div>
