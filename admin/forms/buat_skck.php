...
<div class="content-wrapper">
  ...
  <!--    <form action="../surat/pengantar.php" method="POST"> -->
      <form action="../../proses/tambah_skck.php" method="POST">
 ...
 -->
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <div style="width: 100%;">
            <input id="keterangan" type="hidden" name="keterangan" class="form-control col-md-7 col-xs-12"  required="required" value="Untuk membuat surat berkelakuan baik">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div style="width: 100%;">
            <input id="perihal" type="hidden" name="perihal" class="form-control col-md-7 col-xs-12"  required="required" value="Untuk membuat surat berkelakuan baik">
          </div>
        </div><br><br><br>
        <!-- KOLOM KEDUA END -->
