...
<div class="content-wrapper">
  ...
  <section class="content">
   ...
   <div class="box box-default">
    ...
    <!-- /.box-header -->
    <div class="box-body">
     <h3><center>Halaman Surat Pengantar</center></h3><hr><br>
 ...
 -->
        ...
        <div class="form-group">
          ...
          <div style="width: 100%;">
            <input id="keterangan" type="text" name="keterangan" class="form-control col-md-7 col-xs-12"  required="required" placeholder="contoh: pengantar ktp">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div style="width: 100%;">
            <input id="perihal" type="hidden" name="perihal" class="form-control col-md-7 col-xs-12"  required="required" value="Untuk membuat surat pindah datang">
          </div>
        </div><br><br><br>
        <!-- KOLOM KEDUA END -->
