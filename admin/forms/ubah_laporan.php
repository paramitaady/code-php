...
$laporan  = mysqli_fetch_array($data);
...
<section class="content">
  ...
  <div class="box box-default">
    <div class="box-header with-border">
      <h3><center>Form Tambah Laporan</center></h3><hr><br>
      <div class="x_content">
        <form action="../../proses/proses_edit_laporan.php" class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">

          <div class="form-group row">
            <label for="id_laporan" class="control-label col-md-3 col-sm-3 col-xs-12" >ID Laporan
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input class="form-control col-md-7 col-xs-12" name="id_laporan" type="text" required="required" value="<?php echo $laporan['id_laporan'];?>" readonly>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="date" name="tanggal" class="form-control col-md-7 col-xs-12" required="required" value="<?php echo $laporan['tanggal'];?>">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" name="perihal" class="form-control col-md-7 col-xs-12" required="required" value="<?php echo $laporan['perihal'];?>">
            </div>
          </div>
          ...
          <!-- <div class="form-inline row" >
            <label for="link" class="control-label col-md-3 col-sm-3 col-xs-12">Masukkan Link
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <a href="https://www.zippyshare.com/" class="btn btn-info" target="_blank">Link</a>
              <input type="text" name="link" class="form-control" value="<?php echo $laporan['link'];?>" required>
            </div>
          </div>
          <br><br> 
          ...
          <center>
            ...
            <input class="btn btn-primary" type="submit" id="btn-submit" name="submit" value="Submit" onclick="return ubahLaporan();">
          </center>             
