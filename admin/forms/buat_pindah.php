...
<div class="content-wrapper">
  ...
  <section class="content">
   ...
   <div class="box box-default">
    ...
    <!-- /.box-header -->
    <div class="box-body">
     <h3><center>Halaman Surat Pengantar Pindah</center></h3><hr><br>
  <!--    <form action="../surat/pengantar.php" method="POST"> -->
      <form action="../../proses/tambah_pindah.php" method="POST">
 ...
 -->
        ...
        <div class="form-group">
          ...
          <select name="jenis_surat" type="hidden"  class="form-control select2" style="width: 100%;" required="required">
        ...
        <div class="form-group">
          ...
          <div style="width: 100%;">
            <input id="keterangan" type="text" name="keterangan" class="form-control col-md-7 col-xs-12"  required="required" value="Pengantar pindah" >
          </div>
        </div>
         ...
         <div class="form-group">
          ...
          <div style="width: 100%;">
            <input id="tgl_pindah" type="date" name="tgl_pindah" class="form-control col-md-7 col-xs-12"  required="required">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div style="width: 100%;">
            <input id="perihal" type="text" name="perihal" class="form-control col-md-7 col-xs-12"  required="required" value="Untuk mengurus surat pindah">
          </div>
        </div>
