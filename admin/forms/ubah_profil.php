  ...
  <section class="content">
    ...
    <div class="box box-default">
      <div class="box-header with-border">
        ...
        <div class="x_content">
          <form action="../../proses/edit_profil_admin.php" class="form-horizontal form-label-left" method="POST" novalidate>
            <div class="item form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama" required>Nama</label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="nama" class="form-control col-md-7 col-xs-12" name="nama" type="text"  value="<?php echo $admin['nama'];?>" required="required">
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="username" class="form-control col-md-7 col-xs-12" name="username" type="text"  value="<?php echo $admin['username'];?>" required="required">
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="password" type="text" name="password" class="form-control col-md-7 col-xs-12"  placeholder="Masukkan Password Baru Jika Ingin Mengubah Password" required="required">
              </div>
            </div>
