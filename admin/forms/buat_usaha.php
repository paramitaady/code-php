...
<div class="content-wrapper">
  ...
  <section class="content">
   ...
   <div class="box box-default">
    ...
    <!-- /.box-header -->
    <div class="box-body">
     <h3><center>Halaman Surat Memiliki Usaha</center></h3><hr><br>
  <!--    <form action="../surat/pengantar.php" method="POST"> -->
      <form action="../../proses/tambah_usaha.php" method="POST">
 ...
 -->
        ...
        <div class="form-group">
          ...
          <div style="width: 100%;">
            <input id="usaha" type="text" name="usaha" class="form-control col-md-7 col-xs-12"  required="required" placeholder="Contoh: Pangkas rambut/salon">
          </div>
        </div><br><br><br>
        <!-- KOLOM KEDUA END -->
