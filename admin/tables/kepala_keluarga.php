...
//$no_kk = $_GET['no_kk'];
$query = mysqli_query($koneksi, "SELECT * FROM penduduk ORDER BY no_kk");
...
<aside class="main-sidebar">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data Kepala Keluarga Rejo Basuki
      </h1>
      <ol class="breadcrumb">
        <li><a href="../../index_admin.php"><i class="fa fa-dashboard"></i>Dashboard</a></li>
        <li><a href="kepala_keluarga.php">Tabel</a></li>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div><br>
              <center><h2><b>KEPALA KELUARGA</b></h2></center>

              <hr size="2">
            </div>

             <!-- <div class="box-body">
               <a href="../forms/tambah_kk.php" class="btn btn-primary">
                <span class="glyphicon glyphicon-plus"></span> Tambah Kepala Keluarga
              </a><br>
            </div>  -->
                ...
                <tbody>
                 ...
                 while ($penduduk = mysqli_fetch_array($query)) { ?>
                  <tr>
                    ...
                    <td><?php echo $penduduk['status_hub_keluarga'];?></td>
            ...
            <center>
              <a href="data_penduduk.php" class="btn btn-primary" type="submit" name="submit" value="submit">Kembali</a>
            </center>
          </div>
          <!-- /.box-body -->
        </div>
