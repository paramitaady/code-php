...
<head>
  ...
  <link rel="stylesheet" href="../../bower_components/css/sweetalert2.min.css">
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
     ...
     <nav class="navbar navbar-default">
      ...
      <div class="navbar-header pull-right" id="kepala">
        ...
        <div class="box">
          <div class="box-body">
            ...
            <form method="GET" class="form-inline" action="">
              <select name="status_kependudukan" id="form-filter" class="form-control" required="required">
                <option value="">---Pilih Status Penduduk---</option>
                <option value="1">Penduduk Tetap</option>
                <option value="2">Penduduk Pindah</option>
                <option value="3">Penduduk Datang</option>
          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                if (isset($_GET['status_kependudukan'])) {
                  $status = $_GET['status_kependudukan'];
                  ...
                  if ($status == '1') {
                    ...
                    $query = mysqli_query($koneksi, "SELECT pdd.nik, pdd.nama, pdd.jenis_kelamin, pdd.tempat_lahir, pdd.tanggal_lahir, pdd.no_kk, pdd.agama, pdd.status_kependudukan, pdd.status_perkawinan, pdd.kewarganegaraan, pen.tingkat_pendidikan, pek.keterangan FROM pendidikan pen JOIN penduduk pdd ON (pdd.id_pendidikan = pen.id_pendidikan) JOIN pekerjaan pek ON (pdd.id_pekerjaan = pek.id_pekerjaan) WHERE status_kependudukan='Penduduk Pindah'");
                  }else if ($status == '3') {
                    $query = mysqli_query($koneksi, "SELECT pdd.nik, pdd.nama, pdd.jenis_kelamin, pdd.tempat_lahir, pdd.tanggal_lahir, pdd.no_kk, pdd.agama, pdd.status_kependudukan, pdd.status_perkawinan, pdd.kewarganegaraan, pen.tingkat_pendidikan, pek.keterangan FROM pendidikan pen JOIN penduduk pdd ON (pdd.id_pendidikan = pen.id_pendidikan) JOIN pekerjaan pek ON (pdd.id_pekerjaan = pek.id_pekerjaan) WHERE status_kependudukan='Penduduk Datang'");
                  }else if ($status == '4') {
                    $query = mysqli_query($koneksi, "SELECT pdd.nik, pdd.nama, pdd.jenis_kelamin, pdd.tempat_lahir, pdd.tanggal_lahir, pdd.no_kk, pdd.agama, pdd.status_kependudukan, pdd.status_perkawinan, pdd.kewarganegaraan, pen.tingkat_pendidikan, pek.keterangan FROM pendidikan pen JOIN penduduk pdd ON (pdd.id_pendidikan = pen.id_pendidikan) JOIN pekerjaan pek ON (pdd.id_pekerjaan = pek.id_pekerjaan) WHERE status_kependudukan='Meninggal'");
                  }
                  
                }else{

                  // $query = mysqli_query($koneksi, "SELECT * FROM penduduk ORDER BY nik DESC");
                ...
                while ($penduduk = mysqli_fetch_array($query)) { ?>
                  <tr>
                    ...
                    <td>
                      <a href="../forms/ubah_penduduk.php?nik=<?php echo $penduduk['nik']; ?>" class="btn btn-info btn-xs">Edit</a>
                      <!-- <a href="../../proses/proses_hapus_penduduk.php?nik=<?php echo $penduduk['nik'];?>" onClick="return hapus();" class="btn btn-danger btn-xs">Hapus</a> -->
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
