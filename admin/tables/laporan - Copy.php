        ...
        <ul class="nav navbar-nav">
          <li class="dropdown notifications-menu" id="notif">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="label label-danger" id="notifikasi">0</span>
            </a>

            <ul class="dropdown-menu" id="info"> <!-- untuk munculin popup pesan -->
              <li id="loading">
                <a href="#" id="konten-info">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
               ...
               // $id = $_GET['id'];
                ...
                $query = mysqli_query($koneksi, "SELECT * FROM laporan  ORDER BY tanggal ASC");
                ...
                while ($laporan = mysqli_fetch_array($query)) { ?>
                  <tr>
                    ...
                    <td><?php echo $laporan['lampiran'];?></td>
                    <td>
                      <!-- <a class="btn btn-xs btn-success" href="lihat_data.php?id=<?php echo $laporan['id_laporan'];?>?>">Lihat Data</a> -->
                      ...
                      <a href="../../proses/proses_hapus_laporan.php?id_laporan=<?php echo $laporan['id_laporan'];?>" onClick="return hapusPenduduk('hapus?');" class="btn btn-danger btn-xs">Hapus</a>
