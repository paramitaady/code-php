      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-body">
            ...
            <form method="GET" class="form-inline" target="_blank" action="../../print/cetak_data_laporan.php">
              ...
              <select name="tahun" class="form-control">
                ...
                <?php
                $tahun_laporan = "SELECT YEAR(tanggal) AS tahun FROM laporan GROUP BY YEAR(tanggal) ASC"; 
                $sql = mysqli_query($koneksi, $tahun_laporan); 
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  if (isset($_GET['bulan'])) {
                    ...
                    if ($pilihan == '1') {
                      $query = mysqli_query($koneksi, "SELECT * FROM laporan WHERE MONTH(tanggal)='01' AND YEAR(tanggal) = '".$_GET['tahun']."'");
                    }elseif ($pilihan == '2') {
                      $query = mysqli_query($koneksi, "SELECT * FROM laporan WHERE MONTH(tanggal)='02' AND YEAR(tanggal) = '".$_GET['tahun']."'");
                    }elseif ($pilihan == '3') {
                      $query = mysqli_query($koneksi, "SELECT * FROM laporan WHERE MONTH(tanggal)='03' AND YEAR(tanggal) = '".$_GET['tahun']."'");
                    }elseif ($pilihan == '4') {
                      $query = mysqli_query($koneksi, "SELECT * FROM laporan WHERE MONTH(tanggal)='04' AND YEAR(tanggal) = '".$_GET['tahun']."'");
                    }elseif ($pilihan == '5') {
                      $query = mysqli_query($koneksi, "SELECT * FROM laporan WHERE MONTH(tanggal)='05' AND YEAR(tanggal) = '".$_GET['tahun']."'");
                    }elseif ($pilihan == '6') {
                      $query = mysqli_query($koneksi, "SELECT * FROM laporan WHERE MONTH(tanggal)='06' AND YEAR(tanggal) = '".$_GET['tahun']."'");
                    }elseif ($pilihan == '7') {
                      $query = mysqli_query($koneksi, "SELECT * FROM laporan WHERE MONTH(tanggal)='07' AND YEAR(tanggal) = '".$_GET['tahun']."'");
                    }elseif ($pilihan == '8') {
                      $query = mysqli_query($koneksi, "SELECT * FROM laporan WHERE MONTH(tanggal)='08' AND YEAR(tanggal) = '".$_GET['tahun']."'");
                    }elseif ($pilihan == '9') {
                      $query = mysqli_query($koneksi, "SELECT * FROM laporan WHERE MONTH(tanggal)='09'");
                    }elseif ($pilihan == '10') {
                      $query = mysqli_query($koneksi, "SELECT * FROM laporan WHERE MONTH(tanggal)='10' AND YEAR(tanggal) = '".$_GET['tahun']."'");
                    }elseif ($pilihan == '11') {
                      $query = mysqli_query($koneksi, "SELECT * FROM laporan WHERE MONTH(tanggal)='11' AND YEAR(tanggal) = '".$_GET['tahun']."'");
                    }elseif ($pilihan == '12') {
                      $query = mysqli_query($koneksi, "SELECT * FROM laporan WHERE MONTH(tanggal)='12' AND YEAR(tanggal) = '".$_GET['tahun']."'");
                    }
                  }else{
                ...
                // $i = 1;
                 while ($laporan = mysqli_fetch_array($query)) { ?>
                  <tr>
                    ...
                    <td><a  href="../forms/laporan/<?php echo $laporan['lampiran'];?>" target="_blank"><?php echo $laporan['lampiran'];?></a></td>
                    <td>  
                     <!--  <a class="btn btn-xs btn-success" href="lampiran.php?id_laporan=<?php echo $laporan['id_laporan'];?>">Daftar Lampiran</a> -->
               ...
               <?php } 
                ...
                // $notif = mysqli_query($koneksi, "UPDATE laporan SET cek=1 ORDER BY tanggal ASC");
