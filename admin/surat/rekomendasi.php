...
$query = "SELECT pdd.nik, pdd.nama, pdd.jenis_kelamin, pdd.tempat_lahir, pdd.tanggal_lahir, pdd.agama, pdd.alamat, s.no_surat, s.jenis_surat, s.keterangan, s.tanggal, s.organisasi FROM penduduk pdd JOIN surat s ON (s.nik = pdd.nik) WHERE s.id_surat='".$id['id_surat']."'";
      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <br>
            ...
            <table align="center">
              <tr>
                <td><font size="4"><center><u>REKOMENDASI</u></center></font></td>
              </tr>
              <tr>
            ...
            <tr>
              <td colspan="2" ><font size="3"> Membaca Permohonan Di atas, pada dasarnya kami selaku Pemerintah Kampung Rejo <br> Basuki sangat mendukung dan menyetujui maksud dari <?= $hasil2['organisasi'];?> untuk mengajukan permohonan pencairan dana sepanjang tidak bertentangan dengan ketentuan yang berlaku.</font>
              </td>
              </td>
              <tr>
