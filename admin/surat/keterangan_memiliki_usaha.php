...
$query = "SELECT pdd.nik, pdd.nama, pdd.jenis_kelamin, pdd.tempat_lahir, pdd.tanggal_lahir, pdd.agama, pdd.alamat, s.no_surat, s.jenis_surat, s.keterangan, s.tanggal, s.usaha FROM penduduk pdd JOIN surat s ON (s.nik = pdd.nik) WHERE s.id_surat='".$id['id_surat']."'";
      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <br>
            ...
            <table align="center">
              <tr>
                <td><font size="4"><center><u>Surat Keterangan Memiliki Usaha</u></center></font></td>
              </tr>
              <tr>
            ...
            <tr>
              <td colspan="2" ><font size="3"> Yang Bersangkutan Adalah Benar – benar Warga Kampung Rejo Basuki Dan Berdomisili <br> Di <?= $hasil2['alamat'];?>, Dan yang bersangkutan benar-benar memiliki usaha <?= $hasil2['usaha'];?>.</font>
              </td>
              </td>
              <tr>
