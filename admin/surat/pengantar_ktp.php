...
$query = "SELECT pdd.nik, pdd.nama, pdd.jenis_kelamin, pdd.tempat_lahir, pdd.tanggal_lahir, pdd.agama, pdd.alamat, s.no_surat, s.jenis_surat, s.keterangan, s.tanggal, s.perihal FROM penduduk pdd JOIN surat s ON (s.nik = pdd.nik) WHERE s.id_surat='".$id['id_surat']."'";
      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          if (isset($_POST['submit'])) { ?>
            ...
            <table align="center">
              <tr>
                <td><font size="4"><center><u>Surat Pengantar KTP</u></center></font></td>
              </tr>
              <tr>
                <td><font size="3"><center>Nomor : <?= $_POST['no_surat'];?></center></font></td>
              </tr>
            </table>
            <br><br>
            ...
            <tr>
              ...
              <td width="450"><font size="3"> : <?= $_POST['nama'];?></font></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td width="450"><font size="3"> : <?= $_POST['tempat_lahir'];?>, <?= $_POST['tanggal_lahir'];?></font></td>
            </tr>
            <tr>
              <td height="10" colspan="2"></td>
            </tr>
            <tr>
              ...
              <td width="450"><font size="3"> : <?= $_POST['jenis_kelamin'];?></font></td>
            </tr>
            <tr>
              <td height="10" colspan="2"></td>
            </tr>
            <tr>
              ...
              <td width="450"><font size="3"> : <?= $_POST['agama'];?></font></td>
            </tr>
            <tr>
              <td height="10" colspan="2"></td>
            </tr>
            <tr>
              ...
              <td width="450"><font size="3"> : <?= $_POST['alamat'];?></font></td>
            </tr>
            <tr>
              <td height="10" colspan="2"></td>
            </tr>
            ...
            <tr>
              <td colspan="2" ><font size="3"> Yang Bersangkutan Adalah Benar – benar Warga Kampung Rejo Basuki Dan Berdomisili <br> Di <?= $_POST['alamat'];?>, Dan Pengantar ini Diberikan kepada yang Bersangkutan sebagai Persyaratan <br> untuk mengurus Kartu Tanda Penduduk (KTP).</font>
              </td>
              <tr>
                <td colspan="2" height="30"></td>
              </tr>
              <tr>
                 <td colspan="2"><font size="3"> Demikian Surat <?= $hasil2['jenis_surat'];?> ini kami buat dengan sebenarnya dan agar dapat dipergunakan <br> sebagaimana mestinya.</font></td>
              </tr>
            </tr>
          </table>
          <br><br>
          ...
          <table align="right">
            <tr>
              <td><font size="3"> Rejo Basuki, <?= $_POST['tanggal'];?> </font></td>
            </tr>
            <tr>
