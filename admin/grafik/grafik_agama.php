      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-body">
            ...
            <center><h3><b>GRAFIK DATA AGAMA</b></h3></center>
            <br>
          </div>
          <div>            
          </div>           
          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php
                $query = mysqli_query($koneksi, "SELECT agama, COUNT(*) AS jumlah FROM penduduk GROUP BY agama");
              ...
              var myChart = new Chart(ctx, {
                ...
                data: {
                  ...
                  datasets: [{
                    ...
                    data: [
                    <?php 
                    $islam = mysqli_query($koneksi,"SELECT * FROM penduduk WHERE agama='Islam'");
                    echo mysqli_num_rows($islam);
                    ?>, 
                    <?php 
                    $kristen = mysqli_query($koneksi,"SELECT * FROM penduduk WHERE agama='Kristen'");
                    echo mysqli_num_rows($kristen);
                    ?>,
                    <?php 
                    $katolik = mysqli_query($koneksi,"SELECT * FROM penduduk WHERE agama='Katolik'");
                    echo mysqli_num_rows($katolik);
                    ?>,
                    <?php 
                    $hindu = mysqli_query($koneksi,"SELECT * FROM penduduk WHERE agama='Hindu'");
                    echo mysqli_num_rows($hindu);
                    ?>,
                    <?php 
                    $bunda = mysqli_query($koneksi,"SELECT * FROM penduduk WHERE agama='Bunda'");
                    echo mysqli_num_rows($bunda);
                    ?>,       
                    ],
                    backgroundColor: [
                    'black',
