      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <hr size="2">
           ...
           <form method="GET" class="form-inline" target="_blank" action="../../print/cetak_data_penduduk.php">
          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <?php
                // $bulan = date("m");
                $query = mysqli_query($koneksi, "SELECT status_kependudukan, COUNT(*) AS jumlah FROM penduduk WHERE MONTH(tgl_perubahan)='".date('m')."' GROUP BY status_kependudukan");
              ...
              var myChart = new Chart(ctx, {
                ...
                data: {
                  ...
                  datasets: [{
                    ...
                    ?>,
                    <?php 
                    $pdd_meninggal = mysqli_query($koneksi,"SELECT * FROM penduduk WHERE status_kependudukan='Meninggal' AND MONTH(tgl_perubahan)='".date('m')."'");
