        ...
        <div class="box">
          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
               <?php
               $query = mysqli_query($koneksi, "SELECT status_kependudukan, COUNT(*) AS jumlah FROM penduduk GROUP BY status_kependudukan");
            ...
            var myChart = new Chart(ctx, {
              ...
              data: {
                ...
                datasets: [{
                  ...
                  ?>, 
                  <?php 
                  $pdd_tidak_tetap = mysqli_query($koneksi,"SELECT * FROM penduduk WHERE status_kependudukan='Penduduk Tidak Tetap'");
                  echo mysqli_num_rows($pdd_tidak_tetap);
                  ?>
                  ],
                  backgroundColor: [
