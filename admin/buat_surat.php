            ...
            <div class="box-body">
                 ...
                 if (isset($_GET['surat'])) {
                  ...
                  if ($pilihan == '1') {
                   ...
                   echo "<script>location.href='forms/buat_pengantar.php'</script>";
                    ...
                    echo "<script>location.href='forms/buat_skck.php'</script>";
                    
                  }elseif ($pilihan == '6') {
                    echo "<script>location.href='forms/buat_tempat_tinggal.php'</script>";
                    
                  }elseif ($pilihan == '7') {
                    echo "<script>location.href='forms/buat_usaha.php'</script>";     
                  }elseif ($pilihan == '8') {
                    echo "<script>location.href='forms/buat_rekomendasi.php'</script>";
                  }
