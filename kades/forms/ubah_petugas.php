  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="ubah_petugas.php">Form</a></li>
    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3><center>Ubah Informasi Data Profil</center></h3><br>
          <div class="x_content">
            <form action="../../proses/proses_edit_petugas.php" class="form-horizontal form-label-left" novalidate method="POST">

              <div class="item form-group">
                <label  for="id_petugas" class="control-label col-md-3 col-sm-3 col-xs-12">ID Petugas</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="id_petugas" class="form-control col-md-7 col-xs-12" name="id_petugas" type="text" value="<?php echo $petugas['id_petugas'];?>" readonly>
                </div>
              </div>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="nama" class="form-control col-md-7 col-xs-12" name="nama" type="text" value="<?php echo $petugas['nama'];?>" required="requred">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="username" class="form-control col-md-7 col-xs-12" name="username" type="text" value="<?php echo $petugas['username'];?>" required="required">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="password" type="text" name="password" class="form-control col-md-7 col-xs-12" value="<?php echo $petugas['password'];?>" required="required">
                </div>
              </div>

              <center>
                <a href="../tables/data_petugas.php" class="btn btn-warning" type="submit" name="submit" value="submit">Batal</a>
                <input class="btn btn-primary" type="submit" id="btn-submit" name="submit" value="Submit" onclick="return editPetugas();">
              </center> 
