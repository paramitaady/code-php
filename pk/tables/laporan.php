  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
          <div class="box-body">
            <a class="btn btn-success" href="laporan.php">Tampilkan Semua Data</a>
            <br>
            <br>
              ...
              <tbody>
                ...
                <?php
                 ...
                 if (isset($_GET['bulan'])) {
                   $filter = $_GET['bulan'];
                    ...
                    if ($filter == '1') {
                      $query = mysqli_query($koneksi, "SELECT * FROM laporan WHERE MONTH(tanggal)='01' ORDER BY tanggal DESC");
                    }elseif ($filter == '2') {
                      $query = mysqli_query($koneksi, "SELECT * FROM laporan WHERE MONTH(tanggal)='02' ORDER BY tanggal DESC");
                    }elseif ($filter == '3') {
                      $query = mysqli_query($koneksi, "SELECT * FROM laporan WHERE MONTH(tanggal)='03' ORDER BY tanggal DESC");
                    }elseif ($filter == '4') {
                      $query = mysqli_query($koneksi, "SELECT * FROM laporan WHERE MONTH(tanggal)='04' ORDER BY tanggal DESC");
                    }elseif ($filter == '5') {
                      $query = mysqli_query($koneksi, "SELECT * FROM laporan WHERE MONTH(tanggal)='05' ORDER BY tanggal DESC");
                    }elseif ($filter == '6') {
                      $query = mysqli_query($koneksi, "SELECT * FROM laporan WHERE MONTH(tanggal)='06' ORDER BY tanggal DESC");
                    }elseif ($filter == '7') {
                      $query = mysqli_query($koneksi, "SELECT * FROM laporan WHERE MONTH(tanggal)='07' ORDER BY tanggal DESC");
                    }elseif ($filter == '8') {
                      $query = mysqli_query($koneksi, "SELECT * FROM laporan WHERE MONTH(tanggal)='08' ORDER BY tanggal DESC");
                    }elseif ($filter == '9') {
                      $query = mysqli_query($koneksi, "SELECT * FROM laporan WHERE MONTH(tanggal)='09' ORDER BY tanggal DESC");
                    }elseif ($filter == '10') {
                      $query = mysqli_query($koneksi, "SELECT * FROM laporan WHERE MONTH(tanggal)='10' ORDER BY tanggal DESC");
                    }elseif ($filter == '11') {
                      $query = mysqli_query($koneksi, "SELECT * FROM laporan WHERE MONTH(tanggal)='11' ORDER BY tanggal DESC");
                    }elseif ($filter == '12') {
                      $query = mysqli_query($koneksi, "SELECT * FROM laporan WHERE MONTH(tanggal)='12' ORDER BY tanggal DESC");
                    }
                  }else{
                ...
                while ($laporan = mysqli_fetch_array($query)) { ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <!-- <a class="btn btn-xs btn-success" href="../../laporan/<?php echo $laporan['lampiran'];?>" target="_blank">Lihat Data</a> -->
                      <!-- <a class="btn btn-xs btn-success" href="../../pk/tables/lampiran.php?id_laporan=<?php echo $laporan['id_laporan'];?>">Daftar Lampiran</a> -->
