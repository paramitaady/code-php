      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-body">
            ...
            <br>
            <center><h3><b>LAPORAN BULANAN KAMPUNG REJO BASUKI</b></h3></center>
            <br>
          </div> 
          ...
          <div class="box-body" id="content">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                while ($laporan = mysqli_fetch_array($query)) { ?>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <!-- <a class="btn btn-xs btn-success" href="../../pk/tables/lampiran.php?id_laporan=<?php echo $laporan['id_laporan'];?>" target="_blank">Daftar Lampiran</a> -->
               ...
               //set sudah dibaca = 1 kalau sudah dibaca
                $notifikasi = mysqli_query($koneksi, "UPDATE laporan SET dilihat=1 WHERE id_laporan='$id_laporan'");
...
function cek(){ //function untuk mengecek pesan
  $.ajax({
        url: "cek_notif.php", //script untuk mengecek pesan, di dalamnya berupa query select
        cache: false,
